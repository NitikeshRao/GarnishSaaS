...
class CreditorDebtAppliedRule(models.Model):
    state = models.ForeignKey('processor.GarnishmentState', on_delete=models.CASCADE, db_index=True)
    ...
    withholding_cap = models.CharField(max_length=1600, blank=True, null=True)
