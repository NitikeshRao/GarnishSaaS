...
from garnish_processing_app.models import (state_tax_levy_applied_rule,creditor_debt_applied_rule,state_tax_levy_config, state_tax_levy_exempt_amt_config, creditor_debt_applied_rule,AddExemptions,StdExemptions,ThresholdAmount,state_tax_levy_applied_rule, state_tax_levy_exempt_amt_config, state_tax_levy_config)
from employee.models import ( employee_detail, 
    employee_batch_data, garnishment_batch_data, payroll_taxes_batch_data
)
from garnish_processing_app.serializers import (ThresholdAmountSerializer, AddExemptionSerializer, StdExemptionSerializer,
...
from garnish_processing_app.garnishment_library.calculations import (StateAbbreviations,ChildSupport, SingleChild, MultipleChild,GarFeesRulesEngine,FederalTax,StateTaxLevyCalculator,CreditorDebtCalculator,StudentLoanCalculator)
    ...
    def preload_config_data(self, garnishment_types):
        ...
        try:
            ...
            if GT.FEDERAL_TAX_LEVY in garnishment_types:
                # Get additional exemptions from AddExemptions model
        ...
        try:
            with transaction.atomic():
                ...
                payroll_taxes_batch_data.objects.update_or_create(
                    case_id=case_id, defaults={**payroll_defaults, "ee_id": ee_id})
