...
from garnish_processing_app.models.garnishment_fees_models import garnishment_fees_rules
from django.core.exceptions import ValidationError
from garnish_processing_app.garnishment_library.utility_class import ResponseHelper

from garnish_processing_app.serializers.garnishment_fees_serializers import GarnishmentFeesRulesSerializer
...
class GarnishmentFeesRules(APIView):
    ...
    def get(self, request, rule=None):
        ...
        try:
            if rule:
                rule_obj = garnishment_fees_rules.objects.get(rule__iexact=rule)
