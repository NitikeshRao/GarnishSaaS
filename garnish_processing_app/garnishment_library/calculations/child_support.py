...
from garnish_processing_app.garnishment_library.helper import AllocationMethodResolver,StateAbbreviations,WLIdentifier
from constants.constants import (
    EmployeeFields, CalculationFields, PayrollTaxesFields,
    JSONPath, AllocationMethods
)
from garnish_processing_app.garnishment_library.helper import Helper
...
class MultipleChild(ChildSupportHelper):
    ...
    def calculate(self, record):
        try:
            ...
            if ade >= twa:
                cs_amounts = self._calculate_each_amount(self,tcsa,"child support amount") 
                ar_amounts = self._calculate_each_amount(self,tcsa,"arrear amount") 
            else:
