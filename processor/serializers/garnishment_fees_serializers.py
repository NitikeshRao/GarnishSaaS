...
from processor.models import GarnishmentState, GarnishmentType
...
class StateField(serializers.Field):
    def to_representation(self, value: GarnishmentState):
        return value.state if value else Noneprocessor/models/garnishment_fees/fees.py


    def to_internal_value(self, data):
        try:
            return GarnishmentState.objects.get(state__iexact=data)
        except GarnishmentState.DoesNotExist:
