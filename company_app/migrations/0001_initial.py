# Generated by Django 5.0.9 on 2025-09-12 12:53
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        related_name="business_owner_info",
                        to="company_app.firms",
                        to_field="account_id",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=100, verbose_name="Firm Registration Type"
                    ),
                ),
                ...
                (
                    "pan_front",
                    models.FileField(blank=True, null=True, upload_to="pan_docs/"),
                ),
                (
                    "pan_back",
                    models.FileField(blank=True, null=True, upload_to="pan_docs/"),
                ...
                (
                    "aadhaar_front",
                    models.FileField(blank=True, null=True, upload_to="aadhaar_docs/"),
                ),
                (
                    "aadhaar_back",
                    models.FileField(blank=True, null=True, upload_to="aadhaar_docs/"),
                ...
                (
                    "tax_type",
                    models.CharField(
                        choices=[("GST", "GST"), ("Non GST", "Non GST")], max_length=50
                    ),
                ),
                ("gst_number", models.CharField(blank=True, max_length=20, null=True)),
                (
                    "gst_certificate",
                    models.FileField(blank=True, null=True, upload_to="gst_docs/"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
