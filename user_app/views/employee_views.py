...
class EmployeeHTMLView(TemplateView):
    template_name = "modules/employee/index.html"

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['employees'] = EmployeeDetail.objects.filter(is_active=True).order_by('-created_at')
        print("context['employees']",context['employees'])
        return context
