...
from processor.models.shared_model.state import GarnishmentState
...
class Client(models.Model):
    ...
    state = models.ForeignKey('processor.GarnishmentState', on_delete=models.CASCADE, related_name="clients")
