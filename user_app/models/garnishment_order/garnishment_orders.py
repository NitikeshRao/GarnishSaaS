...
class GarnishmentOrder(models.Model):
    ...
    work_state = models.ForeignKey('processor.GarnishmentState', on_delete=models.CASCADE, related_name="work_garnishments")
    issuing_state = models.ForeignKey(
        'processor.GarnishmentState', on_delete=models.CASCADE, related_name="garnishments")
