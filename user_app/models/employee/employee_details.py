...
class EmployeeDetail(models.Model):
    ...
    home_state = models.ForeignKey('processor.GarnishmentState', on_delete=models.CASCADE, related_name="employees_home")
    work_state = models.ForeignKey('processor.GarnishmentState', on_delete=models.CASCADE, related_name="employees_work")
